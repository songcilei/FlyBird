...
namespace MoreMountains.CorgiEngine
{
	...
	public class Loot : CorgiMonoBehaviour
	{
		...
		/// - loot definition : a LootTable scriptable object (created by right click > Create > MoreMountains > Corgi Engine > Loot Definition
		/// This loot definition can then be reused in other Loot objects.
		[Tooltip("the selected loot mode : - unique : a simple object  - loot table : a LootTable specific to this Loot object - loot definition : a LootTable scriptable object (created by right click > Create > MoreMountains > Corgi Engine > Loot Definition. This loot definition can then be reused in other Loot objects.")]
